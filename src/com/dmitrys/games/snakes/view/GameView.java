...
import com.dmitrys.games.snakes.view.character.Enemy;
import com.dmitrys.games.snakes.view.character.GameCharacter;
import com.dmitrys.games.snakes.view.character.Hero;
...
public class GameView extends SurfaceView {
    ...
    public static final int THEME_SOUND = 2;
...
//                if (character.isCollision(event.getX(), event.getY())) {
